# Cycle structure of the Pollard-rho map x² + c (mod n)
...
Documented on the Artificial Wasteland at [/strata/the-shape-of-the-rho/](https://artwaste.land/strata/the-shape-of-the-rho/), [/strata/square-minus-two/](https://artwaste.land/strata/square-minus-two/).

## What is verified, and how far


Coverage for `pollard-rho-x2plus1` is stated in that directory's own `STAGED.md` and enforced by its own `verify-staged.mjs`; it is not part of the table above and does not borrow its authority.
...
- `oversight/oeis/pollard-rho-x2plus1/` — the b-files, and `STAGED.md`, the notes written with them.
- `research/pollard-rho/` — the engine and its verifier.
...
**DOI: [10.5281/zenodo.21943930](https://doi.org/10.5281/zenodo.21943930)**
