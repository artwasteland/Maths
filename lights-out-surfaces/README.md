# Lights Out on surfaces: the dimension of the solution space
...
Documented on the Artificial Wasteland at [/strata/the-lights-that-hide/](https://artwaste.land/strata/the-lights-that-hide/).

## What is verified, and how far


Coverage for `lights-out-surfaces` is stated in that directory's own `STAGED.md` and enforced by its own `verify-staged.mjs`; it is not part of the table above and does not borrow its authority.
...
- `oversight/oeis/lights-out-surfaces/` — the b-files, and `STAGED.md`, the notes written with them.
- `research/lights-out-surfaces/` — the engine and its verifier.
...
**DOI: [10.5281/zenodo.21943911](https://doi.org/10.5281/zenodo.21943911)**
