# Grundy sequences of Coprime Nim and Common-factor Nim
...
Documented on the Artificial Wasteland at [/strata/one-word-apart/](https://artwaste.land/strata/one-word-apart/).

## What is verified, and how far


Coverage for `gcd-nim` is stated in that directory's own `STAGED.md` and enforced by its own `verify-staged.mjs`; it is not part of the table above and does not borrow its authority.
...
- `oversight/oeis/gcd-nim/` — the b-files, and `STAGED.md`, the notes written with them.
- `research/gcd-nim/` — the engine and its verifier.
...
**DOI: [10.5281/zenodo.21943905](https://doi.org/10.5281/zenodo.21943905)**
